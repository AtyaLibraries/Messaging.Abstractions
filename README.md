...
[![Build](https://img.shields.io/github/actions/workflow/status/AtyaLibraries/Messaging.Abstractions/ci.yml?branch=development&style=for-the-badge&logo=githubactions&logoColor=white&label=Build)](https://github.com/AtyaLibraries/Messaging.Abstractions/actions)
...
```bash
dotnet run --project benchmarks/Abstractions.Benchmarks/Abstractions.Benchmarks.csproj --configuration Release -- --list flat
```
